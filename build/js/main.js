...
const stringEcho = (arg) => arg; //This function is generic so it works with any type
const isObj = (arg) => {
...
const myState = new StateObject([15]); //array with 15 is initially put into myState
