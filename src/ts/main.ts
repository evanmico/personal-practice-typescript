...
let a: One = 'hello';
let b = a as Two; //b has been assigned to a as a type two, this is assignment to a less specific type
let c = a as Three; // More specific

//This method CANNOT be used in react
let d = <One> 'world'; //using angle brackets to do same type assertion
...
(10 as unknown) as string;//try to avoid this cause it over-rules TS
